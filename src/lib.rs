...
c_type!(
    ...
    0,
    f32,
    |n: i8| n.overflowing_abs().0,
    |l: i8, r: i8| Self::overflowing_add(l, r).0,
    |l: i8, r: i8| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i8, r: i8| Self::overflowing_mul(l, r).0,
    |l: i8, r: i8| Self::overflowing_sub(l, r).0,
    |l: i8, r: i8| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
...
c_type!(
    ...
    0,
    f32,
    |n: i16| n.overflowing_abs().0,
    |l: i16, r: i16| Self::overflowing_add(l, r).0,
    |l: i16, r: i16| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i16, r: i16| Self::overflowing_mul(l, r).0,
    |l: i16, r: i16| Self::overflowing_sub(l, r).0,
    |l: i16, r: i16| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
...
c_type!(
    ...
    0,
    f32,
    |n: i32| n.overflowing_abs().0,
    |l: i32, r: i32| Self::overflowing_add(l, r).0,
    |l: i32, r: i32| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i32, r: i32| Self::overflowing_mul(l, r).0,
    |l: i32, r: i32| Self::overflowing_sub(l, r).0,
    |l: i32, r: i32| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
...
c_type!(
    ...
    0,
    f64,
    |n: i64| n.overflowing_abs().0,
    |l: i64, r: i64| Self::overflowing_add(l, r).0,
    |l: i64, r: i64| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i64, r: i64| Self::overflowing_mul(l, r).0,
    |l: i64, r: i64| Self::overflowing_sub(l, r).0,
    |l: i64, r: i64| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
    |a, e| f64::powi(
        a as f64,
...
c_type!(
    ...
    f32,
    id,
    |l: u8, r: u8| l.overflowing_add(r).0,
    |l: u8, r: u8| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u8, r: u8| l.overflowing_mul(r).0,
    |l: u8, r: u8| l.overflowing_sub(r).0,
    |l: u8, r: u8| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
...
c_type!(
    ...
    f32,
    id,
    |l: u16, r: u16| l.overflowing_add(r).0,
    |l: u16, r: u16| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u16, r: u16| l.overflowing_mul(r).0,
    |l: u16, r: u16| l.overflowing_sub(r).0,
    |l: u16, r: u16| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
...
c_type!(
    ...
    |l: u32, r: u32| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u32, r: u32| l.overflowing_mul(r).0,
    |l: u32, r: u32| l.overflowing_sub(r).0,
    |l: u32, r: u32| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
    |a, e| u32::pow(a, e),
    Ord::max,
    Ord::min
...
c_type!(
    ...
    f64,
    id,
    |l: u64, r: u64| l.overflowing_add(r).0,
    |l: u64, r: u64| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u64, r: u64| l.overflowing_mul(r).0,
    |l: u64, r: u64| l.overflowing_sub(r).0,
    |l: u64, r: u64| l.checked_rem(r).unwrap_or_else(|| 0),
    id,
