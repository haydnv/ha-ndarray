...
c_type!(
    ...
    f32,
    |n: i8| n.wrapping_abs(),
    |l: i8, r: i8| Self::wrapping_add(l, r),
    |l: i8, r: i8| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i8, r: i8| Self::wrapping_mul(l, r),
    |l: i8, r: i8| Self::wrapping_sub(l, r),
...
c_type!(
    ...
    0,
    f32,
    |n: i16| n.wrapping_abs(),
    |l: i16, r: i16| Self::wrapping_add(l, r),
    |l: i16, r: i16| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i16, r: i16| Self::wrapping_mul(l, r),
    |l: i16, r: i16| Self::wrapping_sub(l, r),
...
c_type!(
    ...
    0,
    f32,
    |n: i32| n.wrapping_abs(),
    |l: i32, r: i32| Self::wrapping_add(l, r),
    |l: i32, r: i32| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i32, r: i32| Self::wrapping_mul(l, r),
    |l: i32, r: i32| Self::wrapping_sub(l, r),
...
c_type!(
    ...
    0,
    f64,
    |n: i64| n.wrapping_abs(),
    |l: i64, r: i64| Self::wrapping_add(l, r),
    |l: i64, r: i64| l.checked_div(r).unwrap_or_else(|| 0),
    |l: i64, r: i64| Self::wrapping_mul(l, r),
    |l: i64, r: i64| Self::wrapping_sub(l, r),
...
c_type!(
    ...
    f32,
    id,
    |l: u8, r: u8| l.wrapping_add(r),
    |l: u8, r: u8| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u8, r: u8| l.wrapping_mul(r),
    |l: u8, r: u8| l.wrapping_sub(r),
...
c_type!(
    ...
    f32,
    id,
    |l: u16, r: u16| l.wrapping_add(r),
    |l: u16, r: u16| l.checked_div(r).unwrap_or_else(|| 0),
    |l: u16, r: u16| l.wrapping_mul(r),
    |l: u16, r: u16| l.wrapping_sub(r),
...
c_type!(
    ...
    |l: u32, r: u32| l.wrapping_mul(r),
    |l: u32, r: u32| l.wrapping_sub(r),
